...
SCHEDULE_REQUEST = (
    ...
    "thời tiết và giá xăng ở bên dưới hình, font chữ dễ đọc"
)
IMMEDIATE_REQUEST = (
...
evaluated=subprocess.run(
    ...
    input=evaluation_code,text=True,capture_output=True,timeout=480,
)
