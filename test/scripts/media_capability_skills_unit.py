...
def main() -> int:
    ...
    assert "Author all visible title, label, value prose, and timestamp_label in concise English" in system
    assert "an explicit request to use another language for image text does NOT override English" in system
    assert "not chat or native document text" in system
