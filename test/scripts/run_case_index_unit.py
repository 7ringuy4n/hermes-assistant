...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as temp, patch.object(run_case_index_lab, "OUT", Path(temp)), patch.dict(os.environ, {"CASE_FILTER": "unknown-fixture-case", "SKIP_VPS": "1"}):
        assert run_case_index_lab.main() == 2
