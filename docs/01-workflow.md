...
**As of:** 2026-09-14 (candidate changes require their recorded release gates)

## Request path

Direct Hermes CLI/API sessions execute shared capabilities without Zalo or
Message Worker. Messaging sessions add authenticated conversation scope,
queueing, and channel delivery. See [direct execution contracts](./03-architecture.md)
for local note scope, Hermes-targeted schedules, and destination-free file APIs.
