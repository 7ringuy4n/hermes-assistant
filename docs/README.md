...
| [07-worker-feature-catalog.md](./07-worker-feature-catalog.md) | All current workers/services/features, descriptions, fresh defaults, dependencies and implementation status |
...
| `rule/GIT.md` | Git workflow: develop first, then main after it passes |
