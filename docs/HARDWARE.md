...
- **Backups** grow under `/data/assistant/backups` (retention `BACKUP_RETENTION_DAYS`, default 7 days from the host `.env`). Size disk for at least one full stamp plus working set.
