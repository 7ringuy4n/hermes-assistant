...
# One protocol implementation is shared with Dispatcher, not forked in adapters.
$ZALO_SUDO cp -a "${ROOT}/architect/lib/artifact_delivery.py" "${PLUGIN_DIR}/artifact_delivery.py"
